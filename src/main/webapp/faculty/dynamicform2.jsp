 ...
 <script>
   ...
   var array = new Array();
	...
	function add(type){
			...
			var textboxes=document.getElementsByClassName("wiris");
			var editor;
			editor = com.wiris.jsEditor.JsEditor.newInstance({'language': 'en'});
				editor.insertInto(textboxes[textboxes.length-1]);
				}		
	...
	function generate(){
	  var question_array=[];
			...
			for(var i = 0;i<x.length;i++){
				...
				question["statement"]=x[i].getElementsByClassName("wiris")[0].innerHTML;
				var answer_array=[];
			...
			<div class="box box-solid bg-teal-gradient" data-type="short_answer">
				<div class="box-header">
					<h3 class="box-title col-xs-10">
						<div type="text" class="wiris" cols="130"
							placeholder="Your Question" style="height:200px"></div>
					</h3>
