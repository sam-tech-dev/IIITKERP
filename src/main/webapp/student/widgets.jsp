	...
	<div class="wrapper">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li class="active"><a href="widgets.html"> <i
							class="fa fa-th"></i> <span>Widgets</span> <small
		...
		<div class="content-wrapper">
			...
			<section class="content">
				...
				<div class="row">
					<div
						style="position: fixed; z-index: 10; margin-top: -165px !important;">
						<span id="listPeople">
							<div class="col-md-3">
								<!-- DIRECT CHAT PRIMARY -->
									...
									<div class="box-footer">
											<div class="input-group">
												<input type="text" name="message"
													placeholder="Search People..." class="form-control">
...
<span id="right_message">
                <div class="direct-chat-msg right">
                  ...
                  <!-- /.direct-chat-text -->
									...
									<div class="box-footer">
											<div class="input-group">
												<input type="text" id="chat_message" name="message"
													placeholder="Type Message ..." class="form-control">
												<span class="input-group-btn">
													<button onclick="sendMessage()" type="submit"  class="btn btn-warning btn-flat">SendMessage</button>
												</span>
											</div>
									</div>
									<!-- /.box-footer-->
				...
				<div class="row">
					<div class="col-md-6">
						...
						<div class="box box-widget">
							...
							<!-- /.box-header -->
							<div class="box-body">
								<img class="img-responsive pad" src="../dist/img/photo2.png"
									alt="Photo">
