  ...
  <div class="login-box-body">
    ...
    <form method="post" onSubmit="return authenticate(this.ldap_username.value,this.ldap_password.value)">
      <div class="form-group has-feedback">
        <input type="password" class="form-control" name="ldap_username" onclick="$('#error_username').html('')" id="ldap_username" placeholder="Current Password">
      ...
      <div class="form-group has-feedback">
        <input type="password" class="form-control" name="ldap_password" onclick="$('#error_password').html('')" id="ldap_password" placeholder="New Password">
      ...
      <div class="row">
        <div class="col-xs-5 pull-right">
          <button type="submit" name="ldap_submit" class="btn btn-primary btn-block btn-flat">Confirm</button>
        </div>
      </div>
    </form>
